    ...
    <div>
      ...
      <br/><div className="flex ml-28  text-xl font-sans tracking-wide font-semibold text-black w-96 gap-8 "><Image src={r1} alt=""/><Image src={r2} alt=""/><Image src={r3} alt=""/></div>
        ...
        <div><Card bgcolor='bg-red-700' v='-30%' i={<Image src={h1} alt=""/>} l1='Slytherine' l2='Stylish cafe chair' l3='Rp 2.500.000 ' l4='Rp 3.500.000'/></div><br/><br/>
         <div className="w-60" ><Image className='w-60 h-96' src={h2} alt=""/></div>
        ...
        <div><Card bgcolor='bg-emerald-400' v='NEW' i={<Image src={h6} alt=""/>} l1='Muggo' l2='Small mug' l3='Rp 1.50.000 ' l4='&nbsp;'/></div><br/><br/>
