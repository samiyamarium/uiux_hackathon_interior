  ...
  return (
    <div>
      ...
      <br/><div className="flex  ml-28   text-xl font-sans tracking-wide  font-semibold text-black w-96 gap-8 "><Image src={r1} alt=""/><Image src={r2} alt=""/><Image src={r3} alt=""/></div>
        ...
        <div className="flex flex-wrap sm:grid-cols-1 md:grid-cols-2 lg:grid:cols:4  gap-20 m-40">
        <div><Card bgcolor='bg-red-700' v='-30%' i={<Image src={h1} alt=""/>} l1='Slytherine' l2='Stylish cafe chair' l3='Rp 2.500.000 ' l4='Rp 3.500.000'/></div>
        ...
        <div><Card bgcolor='bg-emerald-400' v='NEW' i={<Image src={h6} alt=""/>} l1='Muggo' l2='Small mug' l3='Rp 1.50.000 ' l4='&nbsp;'/></div>
         ...
         <br/><div className="text-center py-4"><Card bgcolor='bg-emerald-500' v='NEW' i={<Image src={h8} alt=""/>} l1='Potty' l2='Minimalist flower pot' l3='Rp 500.000 ' l4='&nbsp;'/></div>
         </div><br/>
