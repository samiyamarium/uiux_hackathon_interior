    ...
    return(
        <div>
            <div  >
             ...
             </div>     <br/>   <div className='  flex-1  w-96 h-96 bg-orange-500 rounded-md  ml-16 bg-opacity-20 '><p className='text-center pt-12 '><b className='  font-sans text-2xl tracking-wide '>Cart Totals</b></p><br/><br/><div className='mx-8 gap-20 flex'><p className='font-sans text-xl font-semibold'>Sub-Total</p><p className='text-gray-500 text-xl font-sans font-semibold tracking-wide'>Rs.250,000.000</p></div>
