...
export default function Cart(){
    return(
        <div>
            <div  >
                <br/><div><ul className='bg-orange-500 rounded-md  px-44 p-2 flex bg-opacity-20 text-xl font-sans font-bold  gap-4 justify-around text-center  text-black'><li>Product</li><li>Price</li><li>Quantity</li><li>Sub-Total</li> </ul></div>
