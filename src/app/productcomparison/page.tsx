    ...
    return(
        <div>
          ...
          <div  className=" mx-20 w-screen  h-60  text-white bg-[url('/shop.png')] pt-20 bg-cover text-center font-sans text-6xl"><b className=' text-amber-950 opacity-40'>Product Comparison</b><div ></div></div>
                  ...
                  <div className="flex mx-8 gap-8"><p className="font-sans text-semibold "> <Image className="w-24 h-24 rounded-md bg-orange-400 bg-opacity-20" src={sofa} alt=""/><br/><b>Asgard Sofa</b><br/>Rs.250,0000.000<br/>4.7 &#x2B50;&#x2B50;&#x2B50;&#x2B50;&#x2B50;&nbsp;&nbsp;   &#8739; &nbsp;&nbsp; <b className="font-sans text-xs text-gray-500">204 Reviews</b></p>
